    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)BANGALORE    | Rs.600 |   "+available[1]+"   **");
    					System.out.println("** 2.)HYDERABAD    | Rs.170 |   "+available[2]+"   **");
    					System.out.println("** 3.)MYSORE       | Rs.150 |   "+available[3]+"   **");
    					System.out.println("** 4.)COIMBATORE   | Rs.200 |   "+available[4]+"   **");
    					System.out.println("** 5.)CHENNAI      | Rs.250 |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					System.out.println("** 2.)HYDERABAD    | Rs.170 |   "+available[2]+"   **");
    					System.out.println("** 3.)MYSORE       | Rs.150 |   "+available[3]+"   **");
    					System.out.println("** 4.)COIMABATORE  | Rs.200 |   "+available[4]+"   **");
    					System.out.println("** 5.)CHENNAI      | Rs.250 |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
    					System.out.println("PWD, STUDENT, & SENIOR CITIZEN with 20% DISCOUNT!!!\n");
    					...
    					String dest[] = { " ", "BANGALORE", "HYDERABAD", "MYSORE", "COIMBATORE", "CHENNAI"};
